...
export const ProjectShowcase: React.FC<ProjectShowcaseProps> = ({
  ...
  return (
    <div className="bg-[rgba(38,38,39,1)] relative flex min-w-60 min-h-[268px] flex-col overflow-hidden text-white font-bold justify-center flex-1 shrink basis-[0%] px-8 py-[35px] rounded-[20px]">
      ...
      />
      <div onClick={onGoToProjects} className="font-montserrat bg-[rgba(22,22,22,0.62)] hover:bg-[#303031] absolute z-0 gap-3 overflow-hidden -translate-x-2/4 -translate-y-2/4 px-4 py-2 rounded-[200px] left-2/4 top-2/4 cursor-pointer hover:opacity-[0.6] transition-all duration-700">
        See my work
      </div>
    </div>
  );
